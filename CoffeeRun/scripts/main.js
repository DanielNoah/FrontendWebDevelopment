(function(window) {
    ...
    var SERVER_URL = "http://coffeerun-v2-rest-api.herokuapp.com/api/coffeeorders_noAjax";
    var App = window.App;
    var Cafe = App.Cafe;
    ...
    checkList.addClickHandler(myCafe.deliverOrder.bind(myCafe));
...
/*  formHandler.addSubmitHandler(myCafe.createOrder.bind(myCafe)); 첫 submit 핸들러(myCafe.createOrder)가 호출된 후, 폼은 초기화 됨. 
    ...
    formHandler.addSubmitHandler(function (data) {
                                    return myCafe.createOrder.call(myCafe, data) // 위의 문제점을 처리하기 위해 formHandler.addSubmitHandler에 하나의
                                        .then(function() {
